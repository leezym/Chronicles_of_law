...
namespace DIALOGUE.LogicalLines
{
    public class LL_Items : ILogicalLine
    {
        ...
        { 
            ...
            string filePath = FilePaths.GetPathToResource(FilePaths.resources_itemsFiles, "Caso2.Intermedio.DerechoFamilia/"+name); // pdte se debe crear un Level Manager para configurar cada caso en su respectiva variable, crear un banco de casos aleatorio
