...
public class TextArchitect
{
    ...
    public BuildMethod buildMethod = BuildMethod.typewriter; //Definir el metodo de escritura, ahora esta en el script Dialoguesystem*/
    ...
    private void Prepare()
    {
        switch(DialogueSystem.Instance.buildMethod)
        {
            case DialogueSystem.BuildMethod.instant:
                Prepare_Instant();
                break;
            case DialogueSystem.BuildMethod.typewriter:
                Prepare_Typewriter();
